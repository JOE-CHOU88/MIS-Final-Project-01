const { admin, db, storage } = require("../db"); // reference to our db
require("firebase/storage"); // must be required for this to work
const storageRef = storage.bucket(); // create a reference to storage
...
const addImage = async (req, res) => {
  try {
    ...
    const imageRef = storageRef.file(fileName);
